...
class Game {
    ...
    setupZombieEnemies() {
        ...
        // 全局修正：向日葵数（v3.7.2 起三档均保底 3 株，保证"我是僵尸"有稳定回本来源）
        const countType = t => gridPlan.flat().filter(x => x === t).length;
        const sunNeed = { 0: 3, 1: 3, 2: 3 }[cfg.plantTier];
        for (let k = 0; k < 40 && countType('sunflower') + countType('twinsunflower') < sunNeed; k++) {
            const rr = Math.floor(Math.random() * 5), cc = Math.floor(Math.random() * 6);
            if (!gridPlan[rr][cc].startsWith('sun') && !gridPlan[rr][cc].startsWith('twin')) {
                gridPlan[rr][cc] = (cfg.plantTier === 2 && Math.random() < 0.25) ? 'twinsunflower' : 'sunflower';
            }
        }
    ...
    initUI() {
        ...
        this.seeds = [
            { type: 'sunflower', cost: 50, cooldown: 7.5, img: 'assets/images/Card/Plants/SunFlower.png?v=1789999390' },
            { type: 'twinsunflower', cost: 150, cooldown: 50, img: 'assets/images/Card/Plants/TwinSunflower.png?v=1789999390' },
            { type: 'sunshroom', cost: 25, cooldown: 7.5, img: 'assets/images/Card/Plants/SunShroom.png?v=1789999390' },
            { type: 'peashooter', cost: 100, cooldown: 7.5, img: 'assets/images/Card/Plants/Peashooter.png?v=1789999390' },
            { type: 'repeater', cost: 200, cooldown: 7.5, img: 'assets/images/Card/Plants/Repeater.png?v=1789999390' },
            { type: 'threepeater', cost: 300, cooldown: 7.5, img: 'assets/images/Card/Plants/Threepeater.png?v=1789999390' },
            { type: 'gatlingpea', cost: 250, cooldown: 50, img: 'assets/images/Card/Plants/GatlingPea.png?v=1789999390' },
            { type: 'snowpea', cost: 175, cooldown: 7.5, img: 'assets/images/Card/Plants/SnowPea.png?v=1789999390' },
            { type: 'splitpea', cost: 125, cooldown: 7.5, img: 'assets/images/Card/Plants/SplitPea.png?v=1789999390' },
            { type: 'torchwood', cost: 175, cooldown: 7.5, img: 'assets/images/Card/Plants/Torchwood.png?v=1789999390' },
            { type: 'wallnut', cost: 50, cooldown: 30, img: 'assets/images/Card/Plants/WallNut.png?v=1789999390' },
            { type: 'cherrybomb', cost: 150, cooldown: 50, img: 'assets/images/Card/Plants/CherryBomb.png?v=1789999390' },            { type: 'squash', cost: 50, cooldown: 30, img: 'assets/images/Card/Plants/Squash.png?v=1789999390' },
            { type: 'jalapeno', cost: 125, cooldown: 50, img: 'assets/images/Card/Plants/Jalapeno.png?v=1789999390' },
            { type: 'potatomine', cost: 25, cooldown: 30, img: 'assets/images/Card/Plants/PotatoMine.png?v=1789999390' },
            { type: 'chomper', cost: 150, cooldown: 7.5, img: 'assets/images/Card/Plants/Chomper.png?v=1789999390' },
            { type: 'tallnut', cost: 125, cooldown: 30, img: 'assets/images/Card/Plants/TallNut.png?v=1789999390' },
            { type: 'puffshroom', cost: 0, cooldown: 7.5, img: 'assets/images/Card/Plants/PuffShroom.png?v=1789999390' },
            { type: 'fumeshroom', cost: 75, cooldown: 7.5, img: 'assets/images/Card/Plants/FumeShroom.png?v=1789999390' },
            { type: 'scaredyshroom', cost: 25, cooldown: 7.5, img: 'assets/images/Card/Plants/ScaredyShroom.png?v=1789999390' },
            { type: 'gloomshroom', cost: 150, cooldown: 7.5, img: 'assets/images/Card/Plants/GloomShroom.png?v=1789999390' },
            { type: 'spikerock', cost: 125, cooldown: 7.5, img: 'assets/images/Card/Plants/Spikerock.png?v=1789999390' },
            { type: 'cattail', cost: 225, cooldown: 7.5, img: 'assets/images/Card/Plants/Cattail.png?v=1789999390' },
            { type: 'melonpult', cost: 300, cooldown: 7.5, img: 'assets/images/Card/Plants/MelonPult.png?v=1789999390' },{ type: 'iceshroom', cost: 75, cooldown: 50, img: 'assets/images/Card/Plants/IceShroom.png?v=1789999390' },
            { type: 'doomshroom', cost: 125, cooldown: 50, img: 'assets/images/Card/Plants/DoomShroom.png?v=1789999390' },
            { type: 'spikeweed', cost: 100, cooldown: 7.5, img: 'assets/images/Card/Plants/Spikeweed.png?v=1789999390' },
            { type: 'garlic', cost: 50, cooldown: 7.5, img: 'assets/images/Card/Plants/Garlic.png?v=1789999390' },
            // ===== v3.6.0 经典模式新增 4 植物（数值取 PVZ1 原版；融合模式选卡仍过滤为 15 基础牌，不受影响）=====
            { type: 'wintermelon', cost: 200, cooldown: 7.5, img: 'assets/images/Card/Plants/WinterMelon.png?v=1789999390' },
            { type: 'starfruit', cost: 125, cooldown: 7.5, img: 'assets/images/Card/Plants/Starfruit.png?v=1789999390' },
            { type: 'hypnoshroom', cost: 75, cooldown: 30, img: 'assets/images/Card/Plants/HypnoShroom.png?v=1789999390' },
            { type: 'pumpkinhead', cost: 125, cooldown: 30, img: 'assets/images/Card/Plants/PumpkinHead.png?v=1789999390' },
            // ===== v3.10.0 投手两兄弟，v3.11.0 调价（破甲 + 黄油定身很值钱，不再按原版 100 阳光卖）=====
            // 抛射物可破甲：越过路障/铁桶/报纸/铁门直接打僵尸本体，护甲不脱落。
            // 玉米投手另有 20% 概率投出黄油（定身 3 秒）。
            { type: 'cabbagepult', cost: 150, cooldown: 7.5, img: 'assets/images/Card/Plants/CabbagePult.png?v=1789999390' },
            { type: 'kernelpult', cost: 175, cooldown: 7.5, img: 'assets/images/Card/Plants/KernelPult.png?v=1789999390' }
        ];
    ...
    initFusionUI() {
        ...
        const recipes = [
            ...
            { a: 'melonpult', b: 'iceshroom', result: '冰西瓜投手', img: 'assets/images/Plants/WinterMelon/WinterMelon.png?v=1789999390', css: false },
            ...
            { a: 'melonpult', b: 'cattail', result: '西瓜猫尾草', base: 'assets/images/Plants/Cattail/Cattail.gif', over: 'assets/images/Plants/MelonPult/MelonPult.png?v=1789999390', overTransform: 'translate(-5px, -30px) scale(0.7)' },
            { a: 'wintermelon', b: 'cattail', result: '冰西瓜猫尾草', base: 'assets/images/Plants/Cattail/Cattail.gif', over: 'assets/images/Plants/WinterMelon/WinterMelon.png?v=1789999390', overTransform: 'translate(-5px, -30px) scale(0.7)' },
            ...
            { a: 'cabbagepult', b: 'kernelpult', result: '双料投手（3/4 投卷心菜、1/4 投黄油定身 3 秒）', base: 'assets/images/Plants/KernelPult/KernelPult.png?v=1789999390', over: 'assets/images/Plants/CabbagePult/CabbagePult.png?v=1789999390', overClip: 'polygon(0 0, 48% 0, 48% 50%, 0 50%)', overTransform: 'translate(37px, 8px)' },
            { a: 'cabbagepult', b: 'wallnut', result: '卷心菜堡垒（坚果肉盾 + 继续投掷，4000 耐久）', base: 'assets/images/Plants/WallNut/WallNut.gif', over: 'assets/images/Plants/CabbagePult/CabbagePult.png?v=1789999390', overClip: 'polygon(0 0, 46% 0, 46% 46%, 0 46%)', overTransform: 'translate(26px, -4px)' },
            { a: 'cabbagepult', b: 'iceshroom', result: '寒冰卷心菜（破甲 + 命中减速 10 秒）', img: 'assets/images/Plants/CabbagePult/CabbagePult.png?v=1789999390', filter: 'brightness(112%) hue-rotate(120deg) saturate(1.7)', css: false },
            { a: 'kernelpult', b: 'jalapeno', result: '爆米花投手（破甲 + 命中 3×3 溅射）', img: 'assets/images/Plants/KernelPult/KernelPult.png?v=1789999390', filter: 'hue-rotate(-18deg) saturate(1.9) brightness(1.18)', css: false }
        ];
        ...
        recipes.forEach(r => {
            ...
            const getImg = (t) => {
                const map = {
                    ...
                    'melonpult': 'assets/images/Plants/MelonPult/MelonPult.png?v=1789999390',
                    'wintermelon': 'assets/images/Plants/WinterMelon/WinterMelon.png?v=1789999390',
                    ...
                    'cabbagepult': 'assets/images/Plants/CabbagePult/CabbagePult.png?v=1789999390',
                    'kernelpult': 'assets/images/Plants/KernelPult/KernelPult.png?v=1789999390'
                };
                return map[t] || '';
            };
    ...
    shovelPlant(row, col, mouseY) {
        ...
        if (plant.shield && plant.shieldEl) {
            ...
            if (upperHalf) {
                ...
                this.showAnnouncement('已铲掉壳里的植物，南瓜壳留在格内', '#ffe45c');
            } else {
                plant.removeShield(true); // 只铲壳，植物无损
                this.showAnnouncement('已铲掉南瓜壳', '#ffe45c');
            }
    ...
    tryPlanting(type, row, col) {
        ...
        if (this.vaseFreeCards && this.vaseFreeCards.length > 0) {
            ...
            if (fc) {
                ...
                if (this.board.canPlant(row, col)) {
                    ...
                    if (ep && !ep.isDead && type === 'pumpkinhead' && ep.type !== 'pumpkinhead' &&
                        !ep.shield && !ep.shieldEl &&
                        !['cherrybomb', 'jalapeno', 'potatomine', 'squash', 'doomshroom', 'iceshroom', 'crater'].includes(ep.type)) {
                        if (ep.attachShield()) {
                            fc.consumed = true;
                            if (fc.element && fc.element.parentNode) fc.element.parentNode.removeChild(fc.element);
                            this.audioManager.play('plant');
                            this.showAnnouncement(`南瓜套已套在${this.getPlantName(ep.type)}上！(+4000耐久)`, '#ffe45c');
                        }
                    }
                }
            ...
            if (!existingPlant || existingPlant.isDead) {
                ...
                if (this.board.canPlant(row, col)) {
                    ...
                    if (this.board.addPlant(shell, row, col)) {
                        ...
                        this.updateUI();
                        this.audioManager.play('plant');
                        this.showAnnouncement('南瓜壳已就位：把植物种到它上面即可套入', '#ffe45c');
                    }
                }
                return;
            }
            if (existingPlant.type === 'pumpkinhead') {
                this.showAnnouncement('这里已经有南瓜壳了', '#ffaa00');
                return;
            }
        ...
        if (existingPlant && !existingPlant.isDead && existingPlant.type === 'pumpkinhead') {
            ...
            if (this.board.addPlant(plant, row, col)) {
                ...
                this.updateUI();
                this.audioManager.play('plant');
                this.showAnnouncement(`${this.getPlantName(type)}已种进南瓜壳（护甲耐久 ${plant.shield.hp}）`, '#ffe45c');
            }
            return;
        }
    ...
    setupVases() {
        ...
        if (cfg.key === 'hell' && total >= 1) {
            ...
            // v3.16.0：金罐只落在后 4 排（col≥4，远离房子的一侧）
            const idxs = chosen.map((_, i) => i).filter(i => chosen[i][1] >= 4);
        ...
        // v3.16.0：僵尸罐只出现在前 4 排（col≤4，靠近房子一侧）——
        // 统计僵尸罐名额后钉到前排位置，其余类型按原顺序填空
        {
            const zCount = types.filter(t => t === 'zombie').length;
            const frontIdx = [];
            chosen.forEach((pos, i) => { if (pos[1] <= 4) frontIdx.push(i); });
            for (let i = frontIdx.length - 1; i > 0; i--) {
                const j = Math.floor(Math.random() * (i + 1));
                [frontIdx[i], frontIdx[j]] = [frontIdx[j], frontIdx[i]];
            }
            const newTypes = new Array(types.length).fill(null);
            frontIdx.slice(0, zCount).forEach(i => { newTypes[i] = 'zombie'; });
            let ti = 0;
            for (let i = 0; i < newTypes.length; i++) {
                if (newTypes[i]) continue;
                while (ti < types.length && types[ti] === 'zombie') ti++;
                newTypes[i] = ti < types.length ? types[ti] : types[types.length - 1];
                ti++;
            }
            types.length = 0;
            types.push(...newTypes);
        ...
        chosen.forEach((pos, i) => {
            ...
            const sprite = isGolden ? 'Vase_Gold.png'
                          ...
                          : 'Vase_Question.png';
            const img = document.createElement('img');
            img.src = 'assets/images/Vase/' + sprite + '?v=1789999390'; // v= 占位,bump_version 替换为新 cache-buster
        ...
        // 被套的罐子外观一致 —— 套壳不代表里面一定是僵尸（问号罐照样可能套出僵尸）。
        {
            ...
            for (const v of wrapCands) {
                ...
                if (wrapped >= wrapTarget) break;
                    ...
                    ov.src = 'assets/images/Plants/PumpkinHead/shield_full.png?v=1789999390'; // v= 占位,bump_version 替换
                    ...
                    back.src = 'assets/images/Plants/PumpkinHead/Pumpkin_back.gif?v=1789999390'; // v= 占位,bump_version 替换
    ...
    // v3.16.0：融合株没有独立卡面 —— 返回两个基础部件（与 Plant.js 构造的 p1/p2 一致）
    _fusionCardParts(type) {
        const map = {
            fusion_peaflower: ['peashooter', 'sunflower'],
            fusion_nutshooter: ['peashooter', 'wallnut'],
            fusion_frostbomb: ['snowpea', 'cherrybomb'],
            fusion_sporemine: ['puffshroom', 'potatomine'],
            fusion_spikynut: ['spikeweed', 'wallnut'],
            fusion_snownut: ['snowpea', 'wallnut'],
            fusion_melon_cattail: ['melonpult', 'cattail'],
            fusion_wintermelon_cattail: ['wintermelon', 'cattail'],
            fusion_chomper_wallnut: ['wallnut', 'chomper'],
            fusion_icecabbage: ['cabbagepult', 'iceshroom'],
            fusion_popcorn: ['kernelpult', 'jalapeno'],
            fusion_cabbagenut: ['cabbagepult', 'wallnut'],
            fusion_veggiepult: ['cabbagepult', 'kernelpult'],
    ...
    _pickGoldenZombie() {
        ...
        const pool = ['peahead', 'nuthead', 'sunhead', 'snowpeahead', 'zomboni', 'zomboni', 'football', 'gargantuar'];
        return pool[Math.floor(Math.random() * pool.length)];
    }
    ...
    _revealZombieFromVase(type, vase) {
        ...
        // v3.18.0：罐中僵尸原地站定（用户要求"罐子里的僵尸不要移动"）——
        // 不行走/不啃食/不跳跨，改用攻击姿态立绘（walk gif 原地踏步观感更差）；
        // 死亡/护甲掉落/减速滤镜等仍正常（Zombie.update 在行走分支前处理）
        z._vaseStatic = true;
        // v3.19.0 修复：v3.18.0 换的 attackSrc 是原版"啃食动画"（ZombieAttack.gif 本身就是吃植物的动作），
        // 导致所有罐中僵尸一出场就在空啃。改用各僵尸目录自带的原版单帧站姿 0.gif
        //（原版《我是僵尸》选人界面即用此图作静态站姿），真站定、不啃不踏步。
        const _vaseStaticPose = {
        ...
        if (_vaseStaticPose) {
            z.element.src = `assets/images/Zombies/${_vaseStaticPose}/0.gif?v=${this.assetStamp()}`;
        } else if (z.walkSrc) {
            z.element.src = z.walkSrc; // 兜底：无站姿图的类型退回行走图
        }
        // v3.15.0：金罐强化 —— 融合植物头僵尸本体仅 200 血，从金罐出来时按"很厉害"定位强化为 1000 血
        //（先强化基准值，地狱 hpMul ×1.35 再在其上生效 —— 顺序不能颠倒）
        if (vase.golden && (type === 'peahead' || type === 'nuthead' || type === 'sunhead' || type === 'snowpeahead')) {
        ...
        this.updateScore();
        const zhName = { normal:'普通僵尸', conehead:'路障僵尸', buckethead:'铁桶僵尸', flag:'旗手僵尸', polevaulting:'撑杆僵尸', newspaper:'读报僵尸', screendoor:'铁门僵尸', football:'橄榄球僵尸', zomboni:'冰车僵尸', dancing:'舞王僵尸', peahead:'豌豆头僵尸', nuthead:'坚果头僵尸', sunhead:'向日葵头僵尸', snowpeahead:'寒冰头僵尸', gargantuar:'巨人僵尸' }[type] || type;
        ...
        for (let dr = -1; dr <= 1; dr++) {
            for (let dc = -1; dc <= 1; dc++) {
                ...
                if (v.content.kind === 'plant') {
                    ...
                    if (art) {
                        inner.style.backgroundImage = `url('assets/images/Card/Plants/${art}.png?v=${stamp}')`;
                    } else {
                        // v3.16.0：融合株（金罐）—— 双部件合成预览
                        const parts = this._fusionCardParts(v.content.type);
                        const a1 = parts && this.plantCardArt(parts[0]);
                        if (a1) {
                            inner.style.position = 'relative';
                            inner.style.backgroundImage = `url('assets/images/Card/Plants/${a1}.png?v=${stamp}')`;
                            const ov = this._fusionCardOverlay(v.content.type, stamp, '70%');
                            if (ov) inner.appendChild(ov);
                        }
                    }
