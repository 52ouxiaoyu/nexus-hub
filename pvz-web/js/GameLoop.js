...
class Game {
    ...
    initFusionUI() {
        ...
        const recipes = [
            ...
            { a: 'melonpult', b: 'iceshroom', result: '冰西瓜投手', img: 'assets/images/Plants/WinterMelon/WinterMelon.png', css: false },
        ...
        recipes.forEach(r => {
            ...
            const getImg = (t) => {
                const map = {
                    ...
                    'melonpult': 'assets/images/Plants/MelonPult/MelonPult.png',
                    'wintermelon': 'assets/images/Plants/WinterMelon/WinterMelon.png',
