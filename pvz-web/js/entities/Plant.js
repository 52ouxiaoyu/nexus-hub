class Plant extends Entity {
    constructor(game, type) {
        ...
        const getStats = (t) => {
            ...
            stat.fireRate = 1.0;
            stat.fireTimer = 0;
            stat.src = 'assets/images/Plants/MelonPult/MelonPult.png?v=1788958195';
        } else if (type === 'wintermelon') {
            stat.hp = 300;
            stat.fireRate = 1.0;
            stat.fireTimer = 0;
            stat.src = 'assets/images/Plants/WinterMelon/WinterMelon.png?v=1788958195';
            ...
            stat.hp = 300;
            stat.src = 'assets/images/Plants/Plantern/0.gif?v=1788958195';
            stat.yOffset = 0;
        }
