class Projectile extends Entity {
    constructor(game, x, y, row, type = 'peashooter', targetZombie = null, vx = null, vy = null) {
        ...
        if (type === 'snowpea') {
            ...
            this.element.src = 'assets/images/Plants/MelonPult/Melon.png?v=1788879295';
            this.element.style.transform = 'scale(1.0)';
            this.element.style.borderRadius = '50%';
            this.damage = 60;
        } else if (type === 'wintermelon') {
            this.element.src = 'assets/images/Plants/MelonPult/WinterMelon.png?v=1788879295';
            this.element.style.transform = 'scale(1.0)';
            this.element.style.borderRadius = '50%';
            this.damage = 60;
            ...
            this.element.src = 'assets/images/Plants/MelonPult/Melon_small.png?v=1788879295';
            this.element.style.transform = 'scale(0.8)';
            this.element.style.borderRadius = '50%';
            this.damage = 60;
            this.speed = 400;
        } else if (type === 'cattail_wintermelon') {
            this.element.src = 'assets/images/Plants/MelonPult/WinterMelon_small.png?v=1788879295';
            this.element.style.transform = 'scale(0.8)';
            this.element.style.borderRadius = '50%';
            this.damage = 60;
            this.speed = 400;
