    ...
    constructor(game, x, y, row, type = 'peashooter', targetZombie = null, vx = null, vy = null) {
        ...
        if (type === 'snowpea') {
            ...
            this.element.src = type === 'melon'
                ? 'assets/images/Plants/MelonPult/Melon.png?v=1790426098'
                : 'assets/images/Plants/MelonPult/WinterMelon.png?v=1790426098';
            ...
            this.element.src = 'assets/images/Plants/CabbagePult/Cabbage.png?v=1790426098';
            ...
            this.element.src = 'assets/images/Plants/KernelPult/Kernel.png?v=1790426098';
            ...
            this.element.src = 'assets/images/Plants/CobCannon/Cob.png?v=1790426098';
            ...
            this.element.src = 'assets/images/Plants/KernelPult/Butter.png?v=1790426098';
            ...
            this.element.src = 'assets/images/Plants/MelonPult/Melon.png?v=1790426098';
            this.setTransform();
            this.damage = 60;   // v3.28.0：与普通西瓜同档（直击60+溅射30），速度保留猫尾草的 400
            this.speed = 400;
        } else if (type === 'cattail_wintermelon') {
            // v3.28.0：铁冰西瓜猫尾草同理——冰瓜弹与普通冰西瓜同尺寸同贴图
            this.element.src = 'assets/images/Plants/MelonPult/WinterMelon.png?v=1790426098';
            this.setTransform();
