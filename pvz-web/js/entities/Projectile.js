class Projectile extends Entity {
    constructor(game, x, y, row, type = 'peashooter', targetZombie = null, vx = null, vy = null) {
        ...
        // v3.23.0：发射音效——每种植物攻击声音不同（豌豆噗/蘑菇喷气/投手风声/星光闪音）
        const launchFx = {
            peashooter: 'pea_pop', snowpea: 'ice_pop', backpea: 'pea_pop', cherrypea: 'pea_pop',
            firepea: 'fire_pop', scaredyshroom: 'puff', puffshroom: 'puff', gloom_puff: 'puff', fume_burst: 'puff',
        ...
        if (type === 'snowpea') {
            ...
            this.element.src = type === 'melon'
                ? 'assets/images/Plants/MelonPult/Melon.png?v=1790340453'
                : 'assets/images/Plants/MelonPult/WinterMelon.png?v=1790340453';
            ...
            this.element.src = 'assets/images/Plants/CabbagePult/Cabbage.png?v=1790340453';
            ...
            this.element.style.height = '31px';
            ...
            this.element.src = 'assets/images/Plants/KernelPult/Kernel.png?v=1790340453';
            ...
            this.element.src = 'assets/images/Plants/CobCannon/Cob.png?v=1790340453';
            ...
            this.element.src = 'assets/images/Plants/KernelPult/Butter.png?v=1790340453';
            ...
            this.element.src = 'assets/images/Plants/MelonPult/Melon_small.png?v=1790340453';
            this.setTransform('scale(0.8)');
            this.damage = 60;
            this.speed = 400;
        } else if (type === 'cattail_wintermelon') {
            this.element.src = 'assets/images/Plants/MelonPult/WinterMelon_small.png?v=1790340453';
            this.setTransform('scale(0.8)');
            this.damage = 60;
            this.speed = 400;
        } else if (type === 'puffshroom' || type === 'gloom_puff') {
            this.element.src = 'assets/images/Plants/ShroomBullet.gif';
            if (type === 'gloom_puff') this.damage = 80; // v3.21.0：胆小菇(40)的两倍
        ...
        } else if (type === 'fume_burst') {
            // v3.26.0 大喷菇弹幕：小喷菇弹，伤害=小喷菇(20)×2，单发命中（穿门见 CollisionManager pierce 表）
            this.element.src = 'assets/images/Plants/ShroomBullet.gif';
            this.setTransform('scale(0.75)');
            this.damage = 40;
            this.speed = 420;
            this.maxDistance = 340;
            ...
            // v3.23.0：豌豆头/机枪头僵尸射出的豌豆（敌方弹，只打植物，见 CollisionManager）
            this.element.src = 'assets/images/Plants/PB00.gif';
            this.damage = 20;
        } else {
            this.element.src = 'assets/images/Plants/PB00.gif';
        ...
        if (this.type === 'cattail' || this.type === 'cattail_melon' || this.type === 'cattail_wintermelon') {
            ...
            if (dist < 30) {
                 ...
                 if (this.type === 'cattail_melon' || this.type === 'cattail_wintermelon') {
                     ...
                     if (this.game.audioManager.playFx) this.game.audioManager.playFx('crash'); // v3.23.0 瓜果碎裂
            ...
            if (this.type === 'gloom_puff') {
                ...
                for (let z of zombies) {
                    ...
                    let dy = z.y + 50 - this.y;
                    if (Math.hypot(dx, dy) < 40) {
                        // v3.26.0：忧郁菇孢子穿铁门（pierce）——铁门挡不住，直接打本体
                        z.takeDamage(this.damage, { pierce: true });
                        this.isDead = true;
                        break;
                    }
                }
                ...
                for (let z of zombies) {
                    ...
                    if (Math.abs(dx) < 45 && Math.abs(dy) < 55) {
                        ...
                        if (this.game.audioManager && this.game.audioManager.playFx) this.game.audioManager.playFx('pea_hit');
                    }
                }
            }
        } else {
